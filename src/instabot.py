...
class InstaBot:
    ...
    def login(self):
        ...
        # DEACTIVATED code because of loggin error
        ...
        # quick and dirty fix for the deactivated code above (because of loggin error)
        r = self.s.get(self.url)
        ...
        if login.status_code == 200:
            ...
            if finder != -1:
                ...
                # !!!! temporary patch for broken JSON load !!!!
                #self.user_id = ui.get_user_id_by_login(self.user_login)
                self.user_id = 222853348
